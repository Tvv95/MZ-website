    ...
    return (
        <div>
            ...
            <ol>
                ...
                <li>Скорость прокачки навыка Разрушение концентрационными спеллами уровня новичок увеличена в 2 раза</li>
                <li>Ребаланс уникального оружия и щитов</li>
                <li>При взломе замков теперь требуется 1/2/3/4/5 отмычек в зависимости от уровня сундука (новичок/ученик/.../мастер)</li>
                <li>Скрытность изменена: противник обнаруживает игрока в 6 раз хуже в зависимости от приближения к нему, в бою уйти в полную скрытность сложнее в 1.5 раза</li>
            </ol>
            <h3>ФИКСЫ:</h3>
            <ol>
                ...
                <li>Эксплойт имени Polaris'а больше нельзя юзать (отменять анимацию атаки блоком)</li>
            </ol>
            <h3>ПРОЧЕЕ:</h3>
            <ol>
